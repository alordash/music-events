...
{:else if fieldType == FieldTypes.EventConcertsAggregated || fieldType == FieldTypes.ConcertGroupsAggregated || fieldType == FieldTypes.GroupArtistsAggregated || fieldType == FieldTypes.ParticipantRepertoiresAggregated}
	<!-- skip -->
{:else}
