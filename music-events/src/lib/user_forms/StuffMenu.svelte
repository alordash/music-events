...
<ul class="list-group">
	<li class="list-group-item"><a href="models/events/load">Events</a></li>
	<li class="list-group-item"><a href="models/concerts/load">Concerts</a></li>
	<li class="list-group-item"><a href="models/viewer_seats/load">Viewer seats</a></li>
